...
var askDiscount = prompt("Do you have a discount code? Type yes or no.");
if (askDiscount === "yes") {
	var askDiscountCode = prompt("What is you discount code?");
	hasDiscount = true;
} else {
	hasDiscount = false;
}
...
function checkDiscountCode(DISCOUNTCODE, askDiscountCode) {
	while (hasDiscount === true) {
	if (DISCOUNTCODE === askDiscountCode) {
...
var subTotal = calculateSubTotal(numPizzas, FLATRATE, DISCOUNTRATE);
...
var total = calculateTotal(subTotal, TAXRATE);
// console.log(total);
